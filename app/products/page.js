...
export default function ProductsPage() {
  ...
  async function handleAddProduct(e) {
    ...
    const qName = query(
      productsRef,
      where("name_lower", "==", nameTrimmed.toLowerCase())
    );
    ...
    if (!snapName.empty)
      return showError(`Product name "${nameTrimmed}" already exists`);
    ...
    if (!form.dynamicPrice) {
      if (!form.priceNonAc || !form.priceAc || !form.priceParcel) {
        return showError(
          "All price fields are required when Dynamic Price is off."
        );
      }
    }
    ...
    <>
      ...
      <div className="products-ui-root" aria-label="Products Management">
          ...
          <form className="products-ui-form" onSubmit={handleAddProduct}>
            <div className="products-ui-container">
              <div className="products-ui-row">
                <label htmlFor="prod-id" className="products-ui-label">
                  Product Id*
                </label>
                <input
                  id="prod-id"
              ...
              <div className="products-ui-row">
                <FiBox />
                <label htmlFor="prod-name" className="products-ui-label">
                  Product Name*
                </label>
                <input
                  id="prod-name"
              ...
              <div className="products-ui-row">
                <FiTag />
                <label htmlFor="prod-section" className="products-ui-label">
                  Section*
                </label>
                <select
                  id="prod-section"
              ...
              <div className="products-ui-row-compact">
                <label
                  htmlFor="prod-gst"
                  className="products-ui-checkbox-label"
                >
                  <input
                    id="prod-gst"
                    type="checkbox"
                ...
                {form.gst && (
                  <>
                    <label
                      htmlFor="prod-gstPercent"
                      className="products-ui-label"
                    >
                      GST % *
                    </label>
                    <input
              ...
              <div className="products-ui-row-compact">
                ...
                >
                  <input
                    ...
                    onChange={handleFormChange}
                  />{" "}
                  Dynamic Price (allows price entry during billing, e.g.,
                  Today’s Special)
                </label>
            ...
            <div className="products-ui-actions">
              <button
                type="submit"
                className="products-ui-btn products-ui-btn-primary  products-btn-bottom"
              >
                <FiPlus /> Add Product
              </button>
              <button
                type="button"
                className="billing-btn secondary products-btn-bottom"
                onClick={clearForm}
              >
                <FiX /> Clear
              </button>
        ...
        <section className="products-ui-card">
          ...
          {userRole === "admin" && (
            <form
              className="products-ui-section-add"
              ...
              {currentProducts.map((prod) =>
                editId === prod.id ? (
                  ...
                  <tr key={prod.id}>
                    ...
                    <td>
                      {prod.incentive ? prod.incentivePercent + "%" : "-"}
                    </td>
